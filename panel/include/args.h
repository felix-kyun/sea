...
void set_option(const char short_name, const char* long_name, const char* description, bool has_value);

// creates an argument
// arguments are positional and have no prefix
void set_argument(const char* name, const char* description, bool is_required);
