...
void
string_set(string* str, string* data)
{
...
void
string_set_cstr(string* str, const char* data)
{
...
void
string_set_cstr_ascii(string* str, const char* data)
{
...
bool
string_equals_cstr(string* str1, const char* str2)
{
